...
@section('title', trans('admin.siswa.actions.edit', ['name' => $siswa->id]))
                ...
                <form class="form-horizontal form-edit" method="post" @submit.prevent="onSubmit" :action="action" novalidate>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-pencil"></i> {{ trans('admin.siswa.actions.edit', ['name' => $siswa->id]) }}
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-5 col-xxl-4">
                            @include('admin.siswa.components.form-elements-right', ['showHistory' => true])
                        </div>
                    </div>
