                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'nisn'">{{ trans('admin.siswa.columns.nisn') }}</th>
                                        <th is='sortable' :column="'nama'">{{ trans('admin.siswa.columns.nama') }}</th>
                                        <th is='sortable' :column="'umur'">{{ trans('admin.siswa.columns.umur') }}</th>
                                        <th is='sortable' :column="'alamat'">{{ trans('admin.siswa.columns.alamat') }}</th>
                                        <th is='sortable' :column="'kota'">{{ trans('admin.siswa.columns.kota') }}</th>
                                        <th is='sortable' :column="'kelas'">{{ trans('admin.siswa.columns.kelas') }}</th>
                                        <th is='sortable' :column="'jurusan'">{{ trans('admin.siswa.columns.jurusan') }}</th>
                                        <th is='sortable' class="text-center" :column="'published_at'">{{ trans('admin.siswa.columns.published_at') }}</th>
                                        <th is='sortable' :column="'enabled'">{{ trans('admin.siswa.columns.enabled') }}</th>
                                    ...
                                    <td>@{{ item.id }}</td>
                                        ...
                                        <td>@{{ item.jurusan }}</td>
                                            ...
                                            <span v-if="item.published_at <= now">
                                                ...
                                                <span v-if="item.published_at > now">
                                                <small>{{ trans('admin.siswa.actions.will_be_published') }}</small><br />
                                                @{{ item.published_at | datetime('DD.MM.YYYY, HH:mm') }}
